    ...
    else if (value_8 >1500)
    {
      if ( value_7 > 1500)
      {
        ...
        //正转
          ...
          {
            value = fmap(value, 1000, 2000, 0, 2.0);
                motor_duty= value + motor_central_duty;
          }
          
          else if (value_5 < 1200 && value_6 >1200  && value_6 <1700)
                {motor_duty= 10.25;} 
          else if (value_5 < 1200 && value_6 >1700) {motor_duty= 10.5;}
                
          else if (value_5 > 1200 &&  value_5<1700  && value_6 <1200) {motor_duty= 10.75;}
                
          else if (value_5 > 1200 &&  value_5<1700  && value_6 >1200  && value_6 <1700) {motor_duty= 11;}
                
          else if (value_5 > 1200 &&  value_5<1700  && value_6 >1700) {motor_duty= 11.25;}
                
          else if (value_5 > 1700 && value_6 <1200) {motor_duty= 11.5;}
                
          else if (value_5 > 1700 && value_6 >1200  && value_6 <1700) {motor_duty= 11.75; }
                  
          else if (value_5 > 1700 && value_6 >1700) {motor_duty= 12;}
      ...
      if ( value_7 < 1500)  
      {
        //反转
            if (value_5 < 1200 && value_6 <1200)
                {value = fmap(value, 2000, 1000, -2.0, 0);
                motor_duty= value + motor_central_duty;}
